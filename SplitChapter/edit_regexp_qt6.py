...
class Ui_edit_regexp(object):
    def setupUi(self, edit_regexp):
        ...
        self.exp_listview = QListWidget(edit_regexp)
        self.exp_listview.setObjectName(u"exp_listview")
        self.exp_listview.setStyleSheet(u"alternate-background-color:rgb(235, 235, 235);")
